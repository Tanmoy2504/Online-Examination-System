...
public class Methods2 {
    ...
    public int addCourse(String course) throws Exception {
        ...
        if (one.executeUpdate() == 1) {
            PreparedStatement ps = cm.prepareStatement("create table " + course + " ( id int primary key auto_increment, questions varchar(1000), answer_one varchar(200), answer_two varchar(200), answer_three varchar(200), answer_four varchar(200), correct_ans varchar(200),ques_id varchar(200));");
    ...
    public int addData(String course_data) throws Exception {
        Connection cm = connection.getConnection("bugdb");
        PreparedStatement pd = cm.prepareStatement("create table " + course_data + " ( student varchar (50), q_no varchar(100), opt varchar(200));");
        int sda = pd.executeUpdate();
        return sda;
    ...
    public int DataStore(String course_data, String uname, String ques, String option) throws Exception {
        Connection cm = connection.getConnection("bugdb");
        PreparedStatement pd = cm.prepareStatement("Insert into table " + course_data + " ( student, q_no, opt)values('" + uname + "','" + ques + "','" + option + ");");
        int sda = pd.executeUpdate();
        return sda;
